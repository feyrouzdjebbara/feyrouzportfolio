    ...
    <a href={project.demo} target="_blank" rel="noopener noreferrer">
      <div className="from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] w-full">
        ...
        <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8 font-mono text-xs md:text-sm lg:text-base text-white space-y-1">
          <p><span className="text-pink-500">const</span> <span className="text-white">project</span> <span className="text-pink-500">=</span> <span className="text-gray-400">{'{'}</span></p>
          <p className="ml-4">
